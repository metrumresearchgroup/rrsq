...
test_that("Returns null when null, no jobs in queue", {
...
test_that("Returns null when null, jobs in queue for other users only", {
...
test_that("Returns queue objects when applicable", {
